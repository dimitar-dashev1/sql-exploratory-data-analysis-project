...
Highlights:
	...
	3. Aggregates customer-level metrics:
		...
		- total products
		- lifespan/transaction frequency (in months)
	4. Calculates KPIs:
...
WITH base_query AS (
/*----------------------------------------------------------------------------
1) Base Query: Retrieves key columns from the tables
----------------------------------------------------------------------------*/
	SELECT
		f.order_number,
		f.product_key, 
...
END AS [customer_segment],
	latest_order_date,
	DATEDIFF (month, latest_order_date, GETDATE ()) AS [order_recency_month],
	total_orders,
	total_sales,
	total_quantity,
	total_products,
